$(function () {
    ...
    $('#dialogEditAcademicPeriod').dialog({
        ...
        buttons: {
            "Guardar": function () {
                ...
                if (bValid) {
                    UpdateAcademicPeriod("/sedoc/Admin/EditAcademicPeriod/", $(this))
                }
            },
            "Cancelar": function () {
    ...
    $("#dialogDeleteAcademicPeriodConfirm").dialog({
        ...
        buttons: {
            "Eliminar": function () {
                DeleteAcademicPeriod("/sedoc/Admin/DeleteAcademicPeriod/", $(this));
            },
            "Cancelar": function () {
                editFields.val("").removeClass("ui-state-error");
    ...
    $('#dialogCreateAcademicPeriod').dialog({
        ...
        buttons: {
            "Crear": function () {
                ...
                if (bValid) {
                    CreateAcademicPeriod("/sedoc/Admin/CreateAcademicPeriod/", $(this))
                }
            },
            "Cancelar": function () {
                createFields.val("").removeClass("ui-state-error");
