$(function () {
    ...
    function setAsignacion() {
        $("#work-area1").html("");
        $("#work-area1").append("<form action='/sedoc/student/evaluateSubordinates2' method='post'> <fieldset>" +
    ...
    $('#dialogEvalSubordinate').dialog({
        ...
        buttons: {
            "Guardar Evaluación": function () {
                ...
                if (bValid) {
                    allFields.removeClass("ui-state-error");
                    SaveEval("/sedoc/student/UpdateEval/", $(this));
                    $(this).dialog("close");
                }
            },
            "Cancelar": function () {
    ...
    function redireccionar() {
        var pagina = "/sedoc/student/listEvaluations/";
    ...
    function getEval() {
        ...
        if (observations != undefined && observations != null) {
            observations = observations.replace("'", "").replace('"', '').replace(':', '');
        }
        ...
        return (idL == "" || idD == "" || idE == "" || idC == "" || EvEst == "" || EvAut == "") ? null : '{ "idlabor": "' + idL + '", "iddocente": "' + idD + '","idevaluacion": "' + idE + '", "EvalEst":"' + EvEst + '", "EvalAut":"' + EvAut + '", "idcuestionario": "' + idC + '", "observaciones": "' + observations + '","calificaciones": ' + cal + '}';
    }
});