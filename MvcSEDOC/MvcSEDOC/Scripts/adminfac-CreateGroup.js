$(function () {
    ...
    var questionnaireVar = "/sedoc/AdminFac/GetQuestionnaireGroups/";
    var saveVar = "/sedoc/AdminFac/CreateQuestionnaire/";
    ...
    $('#dialogCreateQuestionnaire').dialog({
        ...
        buttons: {
            "Crear": function () {
                ...
                if (bValid) {
                    SaveQuestionnaire("/sedoc/AdminFac/AjaxSetQuestionnaire/", $(this))
                }
            },
            "Cancelar": function () {
        ...
        $.getJSON(route, { term: idQ }, function (data) {
            $.each(data, function (key, val) {
                $("#work-area").append("<table id='TableidGroup" + val['id'] + "' class='list' style='width:100%'>" +
                            ...
                            "<tbody></tbody>" +
                            "</table><br/>");
                loadQuestionsFromGroup(val["id"], "/sedoc/AdminFac/GetQuestionsFromGroup/");
            });
        });
    }
