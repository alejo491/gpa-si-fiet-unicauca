$(function () {
    ...
    function setAsignacion() {
        $("#work-area1").html("");
        $("#work-area1").append("<form action='/sedoc/Adminfac/evaluateSubordinates2' method='post'> <fieldset>" +
    ...
    $('#dialogEvalSubordinate').dialog({
        ...
        buttons: {
            "Guardar Evaluación": function () {
                ...
                if (bValid) {
                    allFields.removeClass("ui-state-error");
                    SaveEval("/sedoc/Adminfac/UpdateEval/", $(this));
                    $(this).dialog("close");
                }
            },
            "Cancelar": function () {
    ...
    function redireccionar() {
        var pagina = "/sedoc/Adminfac/ListJefeLabor/";
