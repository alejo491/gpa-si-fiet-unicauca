$(function () {
    /************* VARIABLES *********************/
    var searchQuestionnaireVar = "/sedoc/Admin/SearchQuestionnaire/";
    var searchGroupVar = "/sedoc/Admin/SearchGroup/";
    ...
    $('#dialogEditGroup').dialog({
        ...
        buttons: {
            "Guardar": function () {
                ...
                if (bValid) {
                    allFields.removeClass("ui-state-error");
                    SaveGroup("/sedoc/Admin/EditGroup/", $(this));
                    $(this).dialog("close");
                }
            },
            "Cancelar": function () {
    ...
    $("#dialogDeleteGroupConfirm").dialog({
        ...
        buttons: {
            "Eliminar": function () {
                DeleteGroup("/sedoc/Admin/DeleteGroup/", $(this));
            },
            Cancelar: function () {
                $(this).dialog("close");
            }
    ...
    function loadSortable(idq) {
        $("#sortable").sortable({
            ...
            update: function (event, ui) {
                ...
                $.ajax({
                    cache: false,
                    url: "/sedoc/Admin/SortGroups/?stridq=" + idq,
                    type: 'post',
                    dataType: 'json',
                    data: data2send,
